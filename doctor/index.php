                    ...
                    <center>
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                $sqlmain = "SELECT schedule.*, appointment.apponum, patient.pname, appointment.appodate, appointment.scheduleid
                                            FROM schedule
                                            INNER JOIN appointment ON schedule.scheduleid = appointment.scheduleid
                                            INNER JOIN patient ON appointment.pid = patient.pid
                                            WHERE schedule.docid = $userid AND appointment.scheduleid = schedule.scheduleid
