        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <!-- <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-schedule&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon" style="margin-left:25px;background-image: url('../img/icons/add.svg');">Add a Session</font></button>
                        </a>
                        </div>
                    </td>
                </tr> -->
            ...
            <?php
            $sqlmain = "SELECT appointment.*, schedule.*, doctor.docname, patient.pname, treatment.treatmentname
                        FROM schedule 
                        INNER JOIN appointment ON schedule.scheduleid = appointment.scheduleid 
                        INNER JOIN patient ON patient.pid = appointment.pid 
                        INNER JOIN doctor ON schedule.docid = doctor.docid  
