...
<body>
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("SELECT  * FROM request WHERE stockid IS NOT NULL;");
                                        ...
                                        echo '<tr>
                                            ...
                                            <td style="padding: 10px;">
                                                <div style="display:flex; justify-content: center; gap: 10px; align-items: center;">                                                
                                                    ...
                                                    <a href="?action=edit&id=' . $requestid . '&name='.$stockname.'&error=0" class="non-style-link">
                                                    ...
                                                    <a href="?action=drop&id='.$requestid.'&name='.$stockname.'&error=0" class="non-style-link">
    ...
    <?php include("../includes/get-request-m-s.php"); ?>
    </div>
