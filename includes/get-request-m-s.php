...
if($_GET){
    ...
    if($action=='drop'){
        ...
        <div id="popup1" class="overlay">
                ...
                <center>
                    <h2>Are you sure?</h2>
                    <a class="close" href="request-m-s.php">&times;</a>
                    <div class="content">
                        You want to delete this record<br>('.substr($nameget,0,40).').
                        
                    </div>
                    <div style="display: flex;justify-content: center;">
                    <a href="delete-request-m-s.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                    <a href="request-m-s.php" class="non-style-link"><button  class="btn-primary btn" style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
                            ...
                            <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="label-td" colspan="2">
                                        <label for="stockname" class="form-label">Request ID: </label>
                                    </td>
                                    <td class="label-td" colspan="2">
                                        <p> ' . $requestid . ' (Auto Generated) </p>                                        
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="label-td" colspan="2">
                                    <form action="edit-request-m-s.php" method="POST" class="add-new-form">
                                    <input type="hidden" name="requestid" value="' . $requestid . '">
                                        <input type="text" name="stockname" class="input-text" placeholder="Stock Name" value="' . $stockname . '" readonly>
                                    </td>
        ...
        <div id="popup1" class="overlay">
            <div class="popup">
                ...
                <div style="display: flex;justify-content: center;">
                    <a href="request-m-s.php" class="non-style-link">
