...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2024 at 04:16 PM
...
(1, 'therapist@edoc.com', 'Therapist 1', '123', '000000000', '0110000000', 1, 1),
(2, 'thera2@edoc.com', 'Test Therapist 2', '123', '1000000', '1000000000', 1, 2);
...
(4, 'john@edoc.com', 'John  Doe', 'john', 'Pilipens', '000000000000', '1922-10-30', '09124242242');
...
INSERT INTO `product` (`productid`, `productname`, `productdesc`, `productquantity`, `productprice`, `productimage`, `aid`, `pid`) VALUES
(1, 'Gluta', 'medyo nakaka ishowspeed', 10, 700.00, 'uploads/188280637_473793063717717_6614845259533472257_n.jpg', 1, 0),
(2, 'Kojic', 'Whitens skin', 2, 111.00, 'uploads/qr-code.png', 2, 0),
(3, 'Titan Gel', 'Gel for longer hair', 9001, 99.00, '', 1, 0),
(4, 'French Fries', 'Potatofry', 1535, 95.00, '', 1, 0),
(9, 'Kitten', 'Cute CAT', 1, 1.00, 'uploads/cute-cat.jpg', 2, 0),
(10, 'ERROR', 'ERROR', 404, 404.00, 'uploads/8q3vni.jpg', 2, 0),
(11, '1', '1', 0, 1.00, 'uploads/cute-cat.jpg', 1, NULL),
(12, '1', '1', 0, 1.00, 'uploads/8q3vni.jpg', 1, NULL);
...
(42, 11, 1, '2024-09-13', 'Pending', 1),
(43, 11, 1, '2024-09-13', 'Pending', 1),
(44, 11, 2, '2024-09-13', 'Pending', 1),
(45, 4, 5, '2024-09-13', 'Pending', 1),
(46, 4, 16, '2024-09-13', 'Pending', 1),
(47, 3, 99, '2024-09-13', 'Pending', 1);
...
CREATE TABLE `treatment` (
  ...
  `treatmentimage` longblob NOT NULL,
  `aid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `treatment` (`treatmentid`, `treatmentname`, `treatmentdesc`, `treatmentprice`, `treatmentmax`, `treatmentimage`, `aid`) VALUES
(1, 'GOKU DRIP', 'ITS OVER 9000', 9001.00, 0, 0x75706c6f6164732f7061636b616765322e6a7067, 2),
(2, '1', '1', 1.00, 0, 0x75706c6f6164732f71722d636f64652e706e67, 2),
(5, 'VEGETA DRIP', 'ALWAYS 2ND PLACE', 2.00, 0, 0x75706c6f6164732f7061636b616765382e6a7067, 1),
(8, 'FAMILY YULO 2X', 'anak investment', 3000000.00, 11, 0x75706c6f6164732f7061636b616765392e6a7067, 1),
(9, 'J', 'A', 11.00, 0, 0x75706c6f6164732f7061636b616765332e6a7067, 1),
(10, 'diwata', 'gayuma', 12.00, 0, 0x75706c6f6164732f54696e61676f2046616c6c735f496c6967616e20436974792e4a5047, 1),
(11, 'ALICE GUO', 'PICTURE TIME', 1900.00, 11, 0x75706c6f6164732f387133766e692e6a7067, 1),
(16, '27 daw id', 'what', 27.00, 27, 0x75706c6f6164732f3435323631323035305f3132323039363532363733343434353739365f353334303934373930373835383037373934325f6e2e6a7067, 1);
...
--
ALTER TABLE `treatment`
  MODIFY `treatmentid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
